  ...
  <article v-if="policy">
    ...
    >
      <div class="min-w-0 rounded-xl border border-ui-border bg-ui-surface">
        ...
        >
          <div
            class="inline-flex rounded-lg bg-ui-surface-2 p-1"
            role="tablist"
            aria-label="View"
          >
            <button
      ...
      <aside class="grid gap-8 text-sm lg:(sticky top-6)">
        <div>
          ...
          >
            ...
            <li>
              Save it as <code>{{ fileName }}</code> at the root of your
              repository.
            </li>
            <li>
              Link to it from <code>CONTRIBUTING.md</code> and your pull request
              template.
            </li>
          </ol>
        </div>
        ...
        <div>
          ...
          <ul class="grid gap-1.5">
            <li
              v-for="other in (others ?? []).filter((o) => o.path !== path)"
              :key="other.path"
            >
